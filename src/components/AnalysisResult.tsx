...
import { 
  ...
  MapPin, Box, Truck, ShieldCheck, FileText, Languages, Building2
} from 'lucide-react';
import { ImportAnalysis } from '../services/geminiService';
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm">
        ...
        <button 
          ...
          className="w-full md:w-auto bg-slate-900 text-white px-8 py-3.5 rounded-2xl font-bold text-sm hover:bg-blue-600 transition-all flex items-center justify-center gap-2 shadow-xl shadow-slate-100"
        >
